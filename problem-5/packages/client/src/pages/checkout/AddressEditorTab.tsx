...
import type { AppDispatch, CheckoutAddress, StateEditor } from '../../types'
...
export const AddressEditorTab: React.FC<AddressEditorTabProps> = ({
  ...
  const editAddress: StateEditor<CheckoutAddress> = (key, value) => {
    dispatch({
        ...
        <Container>
          ...
          <Grid container sx={{ paddingTop: 3 }}>
            <Grid item xs={6} sx={{ padding: 1 }}>
              <FormControl fullWidth>
                <InputLabel htmlFor='city-input'>Country</InputLabel>
                <Input
                  fullWidth
                  id='city-input'
                  type='text'
                ...
                />
                <FormHelperText id='city-text'>Your country</FormHelperText>
              </FormControl>
            </Grid>
