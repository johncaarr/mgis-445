...
import type { AppDispatch, CheckoutCard, StateEditor } from '../../types'
...
export const CardEditorTab: React.FC<CardEditorTabProps> = ({
  ...
  const editCard: StateEditor<CheckoutCard> = (key, value) => {
    dispatch({
